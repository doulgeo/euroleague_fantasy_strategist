...
Two problems this solves that build_projections alone can't:
...
) -> tuple[dict[str, Projection], set[str]]:
    """Returns (merged_pool, new_player_ids).
